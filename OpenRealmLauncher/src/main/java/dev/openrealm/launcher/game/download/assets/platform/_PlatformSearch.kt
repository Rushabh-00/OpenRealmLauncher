...
package dev.openrealm.launcher.game.download.assets.platform

import android.util.Log
import dev.openrealm.launcher.BuildKeys
import dev.openrealm.launcher.game.addons.mirror.MirrorPriority
import dev.openrealm.launcher.game.addons.mirror.resolveMirrorPriority
import dev.openrealm.launcher.game.download.assets.mapExceptionToMessage
import dev.openrealm.launcher.game.download.assets.platform.curseforge.CurseForgeSearcher
import dev.openrealm.launcher.game.download.assets.platform.curseforge.MCIM_CURSEFORGE_API
import dev.openrealm.launcher.game.download.assets.platform.curseforge.models.CurseForgeFile
import dev.openrealm.launcher.game.download.assets.platform.modrinth.MCIM_MODRINTH_API
import dev.openrealm.launcher.game.download.assets.platform.modrinth.ModrinthSearcher
import dev.openrealm.launcher.game.download.assets.platform.modrinth.models.ModrinthVersion
import dev.openrealm.launcher.game.download.assets.utils.localizedModSearchKeywords
...
import dev.openrealm.launcher.utils.network.isInterruptedIOException
...
fun mirroredCurseForgeSource(
    ...
    if (BuildKeys.CURSEFORGE_API.isBlank()) {
