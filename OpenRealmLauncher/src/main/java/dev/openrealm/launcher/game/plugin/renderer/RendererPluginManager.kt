...
package dev.openrealm.launcher.game.plugin.renderer
...
import dev.openrealm.launcher.game.plugin.renderer_v2.RendererV2PluginManager
import dev.openrealm.launcher.game.renderer.Renderers

/**
 * FCL、OpenRealmLauncher 渲染器插件，同时支持使用本地渲染器插件
...
object RendererPluginManager: ApkPluginManager() {
    ...
    /**
     * 解析 OpenRealmLauncher、FCL 渲染器插件
     */
