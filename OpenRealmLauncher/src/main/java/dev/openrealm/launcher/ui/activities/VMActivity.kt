...
import dev.openrealm.launcher.bridge.CURSOR_DISABLED
import dev.openrealm.launcher.bridge.FliteTts
import dev.openrealm.launcher.bridge.LoggerBridge
import dev.openrealm.launcher.bridge.ZLBridge
import dev.openrealm.launcher.bridge.ZLBridgeStates
import dev.openrealm.launcher.coroutine.DataBridge
import dev.openrealm.launcher.game.account.Account
import dev.openrealm.launcher.game.input.AWTCharSender
import dev.openrealm.launcher.game.input.CharacterSenderStrategy
import dev.openrealm.launcher.game.input.LWJGLCharSender
import dev.openrealm.launcher.game.launch.GameLauncher
import dev.openrealm.launcher.game.launch.GameService
import dev.openrealm.launcher.game.launch.JvmLaunchInfo
import dev.openrealm.launcher.game.launch.JvmLauncher
import dev.openrealm.launcher.game.launch.LaunchConfig
import dev.openrealm.launcher.game.launch.Launcher
import dev.openrealm.launcher.game.launch.handler.AbstractHandler
import dev.openrealm.launcher.game.launch.handler.GameHandler
import dev.openrealm.launcher.game.launch.handler.HandlerType
import dev.openrealm.launcher.game.launch.handler.JVMHandler
...
import dev.openrealm.launcher.game.sdl.SdlBridge
import dev.openrealm.launcher.game.version.installed.Version
import dev.openrealm.launcher.setting.AllSettings
import dev.openrealm.launcher.setting.enums.ResolutionRule
import dev.openrealm.launcher.terracotta.TerracottaVPNService
...
import dev.openrealm.launcher.ui.components.rememberBoxSize
import dev.openrealm.launcher.ui.control.input.HidableInputLayout
import dev.openrealm.launcher.ui.control.input.TextInputMode
import dev.openrealm.launcher.ui.screens.game.elements.OpenFolderLayer
import dev.openrealm.launcher.ui.screens.game.elements.OpenFolderOperation
import dev.openrealm.launcher.ui.theme.OpenRealmLauncherTheme
import dev.openrealm.launcher.ui.toAndroidString
import dev.openrealm.launcher.utils.computeGameDisplayLayout
import dev.openrealm.launcher.utils.computeGameRenderSize
import dev.openrealm.launcher.utils.device.PhysicalMouseChecker
import dev.openrealm.launcher.utils.getDisplayFriendlyRes
import dev.openrealm.launcher.utils.getParcelableSafely
import dev.openrealm.launcher.utils.rememberGameRenderSize
import dev.openrealm.launcher.viewmodel.ErrorViewModel
import dev.openrealm.launcher.viewmodel.EventViewModel
import dev.openrealm.launcher.viewmodel.GamepadViewModel
...
class VMActivity : BaseAppCompatActivity(), SurfaceTextureListener, SurfaceHolder.Callback {
    ...
    override fun onSurfaceTextureAvailable(surface: SurfaceTexture, width: Int, height: Int) {
        ...
        CallbackBridge.setDirectGamepadEnableHandler {
            LoggerBridge.append("OpenRealmLauncher: Direct gamepad handler enabled")
        }
        if (vmViewModel.isRunning) {
