...
Java_dev_openrealm_launcher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_dev_openrealm_launcher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
    ...
    VkApplicationInfo appInfo = {
            ...
            .pApplicationName = "OpenRealmLauncher",
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "dev/openrealm/launcher/utils/device/VulkanCapabilities");
