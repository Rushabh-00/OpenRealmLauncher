...
-keep class dev.openrealm.launcher.bridge.** { *; }
-keep class dev.openrealm.launcher.utils.device.VulkanChecker {
    *;
}
-keep class dev.openrealm.launcher.utils.device.VulkanCapabilities {
    *;
}
-keep interface dev.openrealm.launcher.utils.device.VulkanLogCallback {
    *;
}
-keep class dev.openrealm.launcher.game.input.CriticalNativeTest {
    *;
}
